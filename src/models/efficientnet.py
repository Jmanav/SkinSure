...
def load_efficientnet_b1(
    path: str, device: torch.device
) -> tuple[EfficientSkinClassifier, list[str]]:
    """Load a trained EfficientNet-B1 checkpoint. Returns (model, classes)."""
    ...
    print(
        f"✓ EfficientNet-B1 | val={ckpt['best_val_acc']*100:.2f}% "
